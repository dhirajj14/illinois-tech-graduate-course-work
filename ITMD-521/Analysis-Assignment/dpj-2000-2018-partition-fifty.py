...
ddecade.repartition(50).write.format("csv").option("compression","lz4").mode("overwrite").save("hdfs://namenode/output/itmd-521/dpj/dpj-2000-2018-partition-fifty.csv")
